...
class LanguageParser(Parser):
    ...
    # Language.g:54:1: func_def : FUNC_NAME ':' body -> FUNC_NAME body ;
    def func_def(self, ):
    ...
    # Language.g:60:1: func_call : FUNC_NAME ;
    def func_call(self, ):
        ...
        try:
            try:
                # Language.g:61:5: ( FUNC_NAME )
                # Language.g:61:7: FUNC_NAME
                pass 
                root_0 = self._adaptor.nil()
    ...
    # $ANTLR start "move"
    # Language.g:64:1: move : ( STEP_FORWARD | TURN_LEFT | TURN_RIGHT | func_call | WS ->);
    def move(self, ):
        ...
        try:
            try:
                # Language.g:65:5: ( STEP_FORWARD | TURN_LEFT | TURN_RIGHT | func_call | WS ->)
                alt1 = 5
                LA1 = self.input.LA(1)
                if LA1 == STEP_FORWARD:
                    alt1 = 1
